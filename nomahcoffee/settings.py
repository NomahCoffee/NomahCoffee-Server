"""
Django settings for nomahcoffee project.
...
ALLOWED_HOSTS = ['nomah-coffee.herokuapp.com', '127.0.0.1', 'nomahcoffee.com']
...
WSGI_APPLICATION = 'nomahcoffee.wsgi.application'
